...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    if (formData.neighborhood && restaurantInfo.delivery?.neighborhoods) {
      const inputHood = formData.neighborhood.trim().toLowerCase();
  ...
  }, [formData.neighborhood, cartTotal, restaurantInfo.delivery]);
    ...
    return (
      <div className="p-4 pb-24">
        ...
        <form onSubmit={handleCheckout} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Bairro (Digite para calcular a taxa)</label>
            <input
              required
              type="text"
